                ...
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div className="info">
                        <div style={{color: "white"}}
                             className="d-block">{userProfile.first_name} {userProfile.last_name}</div>
                    </div>
                </div>
                ...
                <nav className="mt-2">
                    <ul className="nav nav-pills nav-sidebar flex-column" role="menu"
                        ...
                        <li className="nav-item">
                            <OverlayTrigger placement="right" show={props.ShowToolTip} overlay={<Tooltip id={`tooltip-Cuisine`}>Cuisine</Tooltip>}>
                        ...
                        <li className="nav-item">
                            <OverlayTrigger placement="right" show={props.ShowToolTip} overlay={<Tooltip id={`tooltip-Booking`}>Booking</Tooltip>}>
                        ...
                        <li className="nav-item">
                            <OverlayTrigger placement="right" show={props.ShowToolTip} overlay={<Tooltip id={`tooltip-Logout`}>Logout</Tooltip>}>
